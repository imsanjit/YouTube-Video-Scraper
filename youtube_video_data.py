...
Original file is located at
    https://colab.research.google.com/drive/1nLUIm5vOjp32B1sjNEF7tRCKCbhFErKk

# Bankbazaar youtube video data
"""
...
channel_id = 'UCKtawkxbLepdT1-ANmCyYrA' #BB channel ID
...
videos = get_channel_videos('UCKtawkxbLepdT1-ANmCyYrA') #Change channel id to get your channel data
print(f'Total number of video are: {len(videos)}')

## get all video from BB youtube channel in json file
all_Yt_Details = []
...
## get all video from BB youtube channel in excel file
